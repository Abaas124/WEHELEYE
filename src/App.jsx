...
function App() {
  return (
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center justify-between h-16 lg:h-20">
            <div class="flex-shrink-0">
                <a href="#" title="" class="flex">
                    <img class="w-auto h-16 lg:h-10" src="https://img.freepik.com/premium-vector/wh-letters-logo_773550-14.jpg" alt="" />
            ...
            <Link to="/" class="text-base font-medium text-black transition-all duration-200 hover:text-fuchsia-600 focus:text-fuchsia-600">Home</Link>
            <Link to="/products" class="text-base font-medium text-black transition-all duration-200 hover:text-fuchsia-600 focus:text-fuchsia-600">Shop</Link>
            <Link to="/contact" class="text-base font-medium text-black transition-all duration-200 hover:text-fuchsia-600 focus:text-fuchsia-600">Contact</Link>
            <Link to="/about" class="text-base font-medium text-black transition-all duration-200 hover:text-fuchsia-600 focus:text-fuchsia-600">About</Link>
          </div>
      ...
      <section class="py-12 bg-gradient-to-r bg-gray-900 to-blue-600">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div class="xl:flex xl:items-center xl:justify-start">
                ...
                <p class="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright 2024 WEHELEYE Electronics</p>
            </div>
            ...
            <div class="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
                <ul class="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-end">
                    ...
                    <li>
                        <a href="Contact" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Contact Us </a>
                    </li>
