        ...
        <div class="grid items-center grid-cols-1 lg:grid-cols-2 gap-x-12 xl:gap-x-24 gap-y-12">
            <div class="relative lg:mb-12">
                ...
                <div class="pl-12 pr-6">
                    <img class="relative" src="https://img.freepik.com/premium-vector/wh-letters-logo_773550-14.jpg" alt="" />
                </div>
            ...
            <div class="2xl:pl-16">
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">WEHELEYE ELECTRONICS COMPANY</h2>
