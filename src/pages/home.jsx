...
export default function Home() {
    ...
    <section class="bg-[#ffffff] bg-opacity-30 py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    
                    <h1 class="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">WEHELEYE Electronics</h1>
                ...
                <div>
                    <img class="w-full" src="https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/16-9640/media-gallery/silver/touch/notebook-laptop-xps-16-9640-t-silver-gallery-5.psd?fmt=pjpg&pscan=auto&scl=1&wid=3478&hei=2132&qlt=100,1&resMode=sharp2&size=3478,2132&chrss=full&imwidth=5000" alt="" />
                </div>
            </div>
        </div>
    </section>
...
<div class="text-center p-10">
    <h1 class="font-bold text-4xl mb-4">Samlpe Products</h1>
...
<section id="Projects"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="https://media.wired.com/photos/6169f03b58660fcbc5f4ec3b/master/w_1600%2Cc_limit/Gear-Dell-XPS-15-OLED-1.jpg"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="https://www.bell.ca/Styles/images/samsung_Eureka_GS24_Ultra/Samsung_Galaxy_S24_Ultra_5GPlus_Gray_lrg2.png"
                    alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">
...
<section class="py-10 bg-white sm:py-16 lg:py-24">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h4 class="text-xl font-medium text-gray-900">Numbers tell the hard works we’ve done in last 1 years</h4>
        </div>
            ...
            <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                <div class="px-4 py-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h4 class="text-4xl font-bold text-gray-900">1+</h4>
            ...
            <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                <div class="px-4 py-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h4 class="text-4xl font-bold text-gray-900">9+</h4>
            ...
            <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                <div class="px-4 py-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h4 class="text-4xl font-bold text-gray-900">1,499</h4>
